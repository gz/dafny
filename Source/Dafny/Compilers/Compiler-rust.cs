...
namespace Microsoft.Dafny {
  public class RustCompiler : Compiler {
    public RustCompiler(ErrorReporter reporter)
    : base(reporter) {
    ...
    protected override void EmitBuiltInDecls(BuiltIns builtIns, ConcreteSyntaxTree wr) {
      var rt = wr.NewFile("dafnyrt/mod.rs");
      ReadRuntimeSystem("DafnyRuntime.rs", rt);
    }

    const string DafnyTypeDescriptor = "dafnyrt::TypeDescriptor";

    void EmitModuleHeader(ConcreteSyntaxTree wr) {
      wr.WriteLine("// Module {0}", ModuleName);
    ...
    private RustCompiler.ClassWriter CreateClass(string name, bool isExtern, string/*?*/ fullPrintName, List<TypeParameter>/*?*/ typeParameters, List<Type>/*?*/ superClasses, Bpl.IToken tok, ConcreteSyntaxTree wr, bool includeRtd, bool includeEquals) {
    ...
    protected class ClassWriter : IClassWriter {
      public readonly RustCompiler Compiler;
      ...
      public ClassWriter(RustCompiler compiler, string className, bool isExtern, ConcreteSyntaxTree abstractMethodWriter, ConcreteSyntaxTree concreteMethodWriter,
    ...
    private void FinishClass(RustCompiler.ClassWriter cw) {
